...
import time
import requests
receivedData = create_connection("wss://127.0.0.1:6868", sslopt={"cert_reqs": ssl.CERT_NONE})
...
#             try:
#                 req = input(
#                     "Which command would you like to train? (Neutral, Left, Right, Lift, Drop, Push)\n>>> ").lower()
#
